...
WebUI.waitForElementVisible(findTestObject('ADMIN/Cookie Policy/button_Translate'), 0)

WebUI.click(findTestObject('ADMIN/Cookie Policy/button_Translate'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Cookie Policy/textlabel_Translate'), 0)
