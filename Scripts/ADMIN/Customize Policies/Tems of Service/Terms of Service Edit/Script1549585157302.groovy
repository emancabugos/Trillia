...
WebUI.setText(findTestObject('ADMIN/Customize Policies/Terms of Service/textbox_edit text terms'), 'Sample Terms of Service')

WebUI.scrollToElement(findTestObject('ADMIN/Customize Policies/Terms of Service/button_Preview'), 0)

WebUI.click(findTestObject('ADMIN/Customize Policies/Terms of Service/button_Preview'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('ADMIN/Customize Policies/Terms of Service/button_Save'), 0)

WebUI.click(findTestObject('ADMIN/Customize Policies/Terms of Service/button_Save'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Customize Policies/Terms of Service/Success Toaster Message/div_Successterms of service wa'), 
    0)

WebUI.verifyElementText(findTestObject('ADMIN/Customize Policies/Terms of Service/Success Toaster Message/div_terms of service was succe'), 
    'terms of service was successfully saved.')
