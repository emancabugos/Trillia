...
'Must not be able to search the deleted item'
...
WebUI.verifyElementNotHasAttribute(findTestObject('ADMIN/User Mgmt/Items/linktext_itemName'), '', 0, FailureHandling.CONTINUE_ON_FAILURE)
