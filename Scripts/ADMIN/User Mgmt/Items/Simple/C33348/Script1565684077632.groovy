...
'Verify if item deletion will be cancel upon clicking "Close" button'
...
WebUI.verifyElementVisible(findTestObject('ADMIN/User Mgmt/Items/button_popupDelete'))

WebUI.click(findTestObject('ADMIN/User Mgmt/Items/button_deleteClose'))
