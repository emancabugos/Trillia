...
outofStock = WebUI.getText(findTestObject('ADMIN/User Mgmt/Items/value_outStock'))
...
outofStock2 = WebUI.getText(findTestObject('ADMIN/User Mgmt/Items/value_outStock'))

WebUI.verifyLessThan(outofStock, outofStock2)
