...
'Non-Purchasable must be updated\r\n'
...
nonpurchasable = WebUI.getText(findTestObject('ADMIN/User Mgmt/Items/value_nonPurchasable'))
...
nonpurchasable2 = WebUI.getText(findTestObject('ADMIN/User Mgmt/Items/value_itemsFound'))

WebUI.verifyLessThan(nonpurchasable, nonpurchasable2)
