...
WebUI.click(findTestObject('ADMIN/User Mgmt/Users Page/textlink_User Mgmt.'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/User Mgmt/Users Page/textlink_Users'), 0)

WebUI.click(findTestObject('ADMIN/User Mgmt/Users Page/textlink_Users'), FailureHandling.CONTINUE_ON_FAILURE)
