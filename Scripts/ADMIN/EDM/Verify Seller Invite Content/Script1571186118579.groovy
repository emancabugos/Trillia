...
WebUI.waitForElementVisible(findTestObject('ADMIN/Gmail Page/link_Seller Invite2'), 0)

WebUI.delay(0)

WebUI.click(findTestObject('ADMIN/Gmail Page/link_Seller Invite2'))
...
WebUI.verifyElementPresent(findTestObject('EDM/Seller Invite/textlabel_Hi'), 0)

WebUI.verifyElementText(findTestObject('EDM/Seller Invite/textlabel_You are warmly invited to be'), 'You are warmly invited to become a seller on 0625UN!')

WebUI.verifyElementText(findTestObject('EDM/Seller Invite/textlabel_Kindly follow the link below'), 'Kindly follow the link below to join our community.')

WebUI.verifyElementPresent(findTestObject('EDM/Seller Invite/btn_Create Account'), 0)
