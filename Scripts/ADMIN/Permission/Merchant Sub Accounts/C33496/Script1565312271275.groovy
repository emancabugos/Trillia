...
WebUI.waitForElementPresent(findTestObject('ADMIN/New Sidebar Menu/sidemenu_Permission'), 0)

WebUI.click(findTestObject('ADMIN/New Sidebar Menu/sidemenu_Permission'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('ADMIN/Merchant Sub Account/sidemenu_Merchant Sub-Accounts'), 0)
