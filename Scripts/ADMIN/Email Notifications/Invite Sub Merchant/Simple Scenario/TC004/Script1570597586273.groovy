...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/linktext_Edit Invite Merchant SubAcct'), 
    0)

WebUI.click(findTestObject('ADMIN/Email Notifications/Email Template/linktext_Edit Invite Merchant SubAcct'), FailureHandling.CONTINUE_ON_FAILURE)
