...
WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/LinkText_Edit Account Suspended'))

WebUI.click(findTestObject('ADMIN/Email Notifications/textlabel_Account Suspended Desc'))
