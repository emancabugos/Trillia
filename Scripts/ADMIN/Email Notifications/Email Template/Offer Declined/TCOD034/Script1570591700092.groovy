...
WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Parameters/Pricing Parameter/Bulk Delivery Cost'))
...
WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Parameters/Pricing Parameter/Total'))
