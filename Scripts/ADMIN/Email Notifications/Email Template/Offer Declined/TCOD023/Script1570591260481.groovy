...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Welcome Mail/textlabel Header_Email Parameter'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Welcome Mail/textlabel Header_Email Parameter'))
