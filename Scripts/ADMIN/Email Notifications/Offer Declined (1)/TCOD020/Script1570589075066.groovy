...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Welcome Mail/textfield_subject'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Welcome Mail/textfield_subject'))
