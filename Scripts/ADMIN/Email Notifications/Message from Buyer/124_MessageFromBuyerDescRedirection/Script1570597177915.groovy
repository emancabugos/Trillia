...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Message from Buyer Desc'), 
    0)

WebUI.click(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Message from Buyer Desc'))
