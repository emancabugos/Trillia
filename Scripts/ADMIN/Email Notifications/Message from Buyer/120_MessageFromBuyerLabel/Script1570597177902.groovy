...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/MessageFromBuyer'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/MessageFromBuyer'), FailureHandling.CONTINUE_ON_FAILURE)
