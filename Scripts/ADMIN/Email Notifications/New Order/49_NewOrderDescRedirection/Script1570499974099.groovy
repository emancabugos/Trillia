...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/textlabel_New Order Desc'), 0)

WebUI.click(findTestObject('ADMIN/Email Notifications/textlabel_New Order Desc'))
