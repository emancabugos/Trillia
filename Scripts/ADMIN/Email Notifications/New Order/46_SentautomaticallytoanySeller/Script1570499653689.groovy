...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/textlabel_Received Order Desc'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/textlabel_Received Order Desc'), FailureHandling.CONTINUE_ON_FAILURE)
