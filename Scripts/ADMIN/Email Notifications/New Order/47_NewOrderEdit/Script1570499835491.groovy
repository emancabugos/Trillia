...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Linktext_Edit New Order'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Linktext_Edit New Order'), FailureHandling.CONTINUE_ON_FAILURE)
