...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Linktext_Edit Offer from Seller'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Linktext_Edit Offer from Seller'), FailureHandling.CONTINUE_ON_FAILURE)
