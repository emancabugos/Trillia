...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Offer from Seller'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Offer from Seller'), FailureHandling.CONTINUE_ON_FAILURE)
