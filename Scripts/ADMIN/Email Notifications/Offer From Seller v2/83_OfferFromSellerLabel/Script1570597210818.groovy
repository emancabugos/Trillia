...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/OfferFromSeller'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/OfferFromSeller'), FailureHandling.CONTINUE_ON_FAILURE)
