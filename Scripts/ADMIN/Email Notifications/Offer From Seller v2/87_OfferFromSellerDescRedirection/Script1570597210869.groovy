...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Offer from Seller Desc'), 
    0)

WebUI.click(findTestObject('ADMIN/Email Notifications/Email Template/textlabel_Offer from Seller Desc'))
