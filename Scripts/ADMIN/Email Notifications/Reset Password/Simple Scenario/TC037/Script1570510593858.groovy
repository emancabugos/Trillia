...
WebUI.waitForElementVisible(findTestObject('ADMIN/Email Notifications/LinkText_Edit Reset password'), 0)

WebUI.click(findTestObject('ADMIN/Email Notifications/LinkText_Edit Reset password'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyOptionSelectedByLabel(findTestObject('ADMIN/Email Notifications/a_Offer from Seller/dropdown_Template'), 'Reset Password', 
    true, 0)
