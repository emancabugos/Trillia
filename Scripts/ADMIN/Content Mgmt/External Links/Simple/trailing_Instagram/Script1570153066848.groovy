...
WebUI.scrollToElement(findTestObject('ADMIN/External Links/textbox_instagram-text'), 0)

WebUI.setText(findTestObject('ADMIN/External Links/textbox_instagram-text'), '                                                ')

WebUI.click(findTestObject('ADMIN/External Links/button_Save2'))
