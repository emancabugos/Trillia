...
WebUI.click(findTestObject('ADMIN/External Links/textlink_Translate'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/a_Homepage - Buyer/dropdown_Language'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Edit Text/a_Homepage - Buyer/dropdown_Language'))
