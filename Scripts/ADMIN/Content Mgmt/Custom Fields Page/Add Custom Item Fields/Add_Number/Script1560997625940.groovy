...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'Number Mandatory')

WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Number/textfield_minimum'), '0')

WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Number/textfield_maximum'), '9999')
