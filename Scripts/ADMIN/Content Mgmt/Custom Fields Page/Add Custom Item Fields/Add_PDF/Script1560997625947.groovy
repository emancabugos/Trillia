...
WebUI.waitForElementVisible(findTestObject('ADMIN/Custom Item Fields Page/a_PDF File/textlabel_PDFFile'), 0)

WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'Document Mandatory')
