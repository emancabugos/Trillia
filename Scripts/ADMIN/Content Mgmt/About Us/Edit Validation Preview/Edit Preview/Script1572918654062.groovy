...
WebUI.click(findTestObject('ADMIN/About us/button_Preview'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(2)

WebUI.switchToWindowIndex(1)

WebUI.waitForElementVisible(findTestObject('ADMIN/About us/Preview/content'), 0)

WebUI.verifyTextPresent('Building a website is, in many ways, an exercise of willpower. It’s tempting to get distracted by the bells and whistles of the design process, and forget all about creating compelling content.', 
    false)
