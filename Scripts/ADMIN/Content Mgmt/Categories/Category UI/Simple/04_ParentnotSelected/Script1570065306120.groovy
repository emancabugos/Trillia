...
WebUI.waitForElementVisible(findTestObject('ADMIN/Categories/a_Add a Category'), 0)
...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), catname)

WebUI.click(findTestObject('ADMIN/Categories/Category/button_Browse'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Categories/Add Category Popup/input_thumb'), 0)

WebUI.uploadFile(findTestObject('ADMIN/Categories/Add Category Popup/input_thumb'), imagepath)
...
WebUI.scrollToElement(findTestObject('ADMIN/Categories/Add Category Popup/input_btnSaveParentCategory'), 0)
