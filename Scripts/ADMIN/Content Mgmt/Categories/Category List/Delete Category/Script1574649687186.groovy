...
WebUI.click(findTestObject('ADMIN/Categories/Category List/button_Category Delete'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Categories/Category/delete pop-up/textlabel_Are you sure you want to d'), 
    0)

WebUI.click(findTestObject('ADMIN/Categories/Category/delete pop-up/button_okay'), FailureHandling.CONTINUE_ON_FAILURE)
