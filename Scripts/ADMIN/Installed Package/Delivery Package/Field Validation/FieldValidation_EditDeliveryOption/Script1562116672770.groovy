...
WebUI.click(findTestObject('ADMIN/Installed Packages/Delivery Package/button_Edit'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Installed Packages/Delivery Package/z_AddDeliveryOption/textfield_DeliveryOptionName'), 
    0)
...
WebUI.waitForElementVisible(findTestObject('ADMIN/Installed Packages/Delivery Package/z_AddDeliveryOption/z_Country/linktext_SelectNone'), 
    0)

WebUI.click(findTestObject('ADMIN/Installed Packages/Delivery Package/z_AddDeliveryOption/z_Country/linktext_SelectNone'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementNotVisible(findTestObject('ADMIN/Installed Packages/Delivery Package/z_AddDeliveryOption/z_Country/selected_Country'), 
    0)
