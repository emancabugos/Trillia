...
WebUI.waitForElementVisible(findTestObject('ADMIN/Login Config/a_Login Config'), 0)

WebUI.click(findTestObject('ADMIN/Login Config/a_Login Config'), FailureHandling.CONTINUE_ON_FAILURE)
