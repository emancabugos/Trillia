...
WebUI.setText(findTestObject('ADMIN/Account Info/Account details/textbox_password'), 'test')
...
WebUI.verifyElementText(findTestObject('ADMIN/Account Info/Account details/div_Password must contain at l'), 'Password must contain at least 6 characters')
