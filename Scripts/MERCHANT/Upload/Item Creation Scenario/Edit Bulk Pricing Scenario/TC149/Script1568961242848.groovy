...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_end'), 'INVALID!@#$%^&*(')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_end'), 'value', 
    '', 0)
