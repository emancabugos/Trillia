...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_rate_cost'), 'INVALID!@#$%^&*(')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_rate_cost'), 'value', 
    '', 0)
