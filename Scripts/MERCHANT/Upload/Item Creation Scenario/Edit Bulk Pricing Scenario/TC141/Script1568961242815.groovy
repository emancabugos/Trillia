...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/radiobutton_Onwards'), 0)
...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/textlabel_Purchase'), 0)
