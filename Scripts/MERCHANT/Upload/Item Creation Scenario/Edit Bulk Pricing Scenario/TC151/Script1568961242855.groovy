...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/purchase_onwards'), 'INVALID!@#$%^&')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/purchase_onwards'), 'value', 
    '', 0)
