...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_start'), 'INVALID!@#$%^&*(')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_start'), 'value', 
    '', 0)
