...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Image Cropper/cancel'), 0)

WebUI.click(findTestObject('MERCHANT/Image Cropper/cancel'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.takeScreenshot('C:\\Users\\Arcadier\\git\\Trillia\\Screenshot\\TC120.jpg')
