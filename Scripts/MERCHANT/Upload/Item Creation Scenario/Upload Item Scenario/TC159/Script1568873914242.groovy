...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/searchbar_country'), 'Japan')
...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/searchbar_country'), 'Zimbabwe')
...
WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/Purchasable/ph'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/Purchasable/jp'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/Purchasable/zw'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.takeScreenshot('C:\\Users\\Arcadier\\git\\Trillia\\Screenshot\\TC159.jpg')
