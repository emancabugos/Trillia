...
WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/tab_Countries'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.takeScreenshot('C:\\Users\\Arcadier\\git\\Trillia\\Screenshot\\TC094.jpg')
