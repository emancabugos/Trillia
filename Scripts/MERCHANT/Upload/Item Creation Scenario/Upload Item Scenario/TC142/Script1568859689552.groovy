...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_SKU'), 'value', 'SKU000001', 
    0)

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_MOQ'), 'INVALID!@#$%^')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_MOQ'), 'value', '', 0)
