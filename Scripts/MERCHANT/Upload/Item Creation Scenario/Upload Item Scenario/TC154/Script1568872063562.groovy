...
WebUI.verifyElementNotClickable(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_Stocks'))

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_Stocks'), 'value', '10000', 
    0)
