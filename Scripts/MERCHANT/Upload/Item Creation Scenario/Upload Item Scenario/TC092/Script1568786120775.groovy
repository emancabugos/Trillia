...
WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/tab_Basic Details'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.takeScreenshot('C:\\Users\\Arcadier\\git\\Trillia\\Screenshot\\TC092.jpg')
