...
WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/checkbox_purchasable'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.takeScreenshot('C:\\Users\\Arcadier\\git\\Trillia\\Screenshot\\TC158.jpg')
