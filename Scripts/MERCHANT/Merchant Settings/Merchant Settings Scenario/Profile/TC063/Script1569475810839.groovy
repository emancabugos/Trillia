...
WebUI.setText(findTestObject('MERCHANT/User Settings/Profile/textbox_display_name'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Profile/textbox_display_name'), Keys.chord(Keys.BACK_SPACE))
