...
WebUI.setText(findTestObject('MERCHANT/User Settings/Address/textbox_City'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Address/textbox_City'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Address/textbox_City'), 'value', '', 0)
