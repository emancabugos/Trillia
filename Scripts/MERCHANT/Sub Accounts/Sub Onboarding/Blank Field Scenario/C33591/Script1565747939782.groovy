...
WebUI.setText(findTestObject('MERCHANT/Merchant Sub Account/Onboarding/input_reconfirm-password'), 'notmatch')
...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Merchant Sub Account/Onboarding/Error Message/Password not match'), 
    0)
