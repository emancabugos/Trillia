...
WebUI.waitForElementPresent(findTestObject('MERCHANT/Merchant Sub Account/EDM/button_Create Account'), 0)

WebUI.click(findTestObject('MERCHANT/Merchant Sub Account/EDM/button_Create Account'), FailureHandling.CONTINUE_ON_FAILURE)
