...
WebUI.waitForElementPresent(findTestObject('MERCHANT/Merchant Sub Account/Invite Popup/button_Send'), 0)

WebUI.delay(1)

WebUI.setText(findTestObject('MERCHANT/Merchant Sub Account/Invite Popup/textbox_invite_mail'), 'arcadier.tester1@gmail.com,arcadier.tester2@gmail.com')

WebUI.click(findTestObject('MERCHANT/Merchant Sub Account/Invite Popup/button_Send'), FailureHandling.CONTINUE_ON_FAILURE)
