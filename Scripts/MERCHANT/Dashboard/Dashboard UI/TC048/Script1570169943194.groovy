...
WebUI.click(findTestObject('MERCHANT/Dashboard Page/textlabel_Last 30 Days'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementText(findTestObject('MERCHANT/Dashboard Page/Values/value_total sales'), '0')
