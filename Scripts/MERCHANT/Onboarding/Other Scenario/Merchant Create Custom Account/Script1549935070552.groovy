...
WebUI.setText(findTestObject('ADMIN/Admin Login Page/Google Accounts/textbox_username'), GlobalVariable.MerchantNotif)
...
WebUI.setText(findTestObject('MERCHANT/Seller Register Page/textbox_username'), GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('MERCHANT/Seller Register Page/textbox_notif email'), GlobalVariable.MerchantNotif)
