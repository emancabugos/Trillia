...
WebUI.verifyElementText(findTestObject('MERCHANT/User Settings/Address/textlabel_First Name'), 'First Name')

WebUI.verifyElementPresent(findTestObject('MERCHANT/User Settings/Address/textbox_first_name'), 0)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Address/textbox_first_name'), 'placeholder', 'Pre-populated if can be pulled', 
    0)
