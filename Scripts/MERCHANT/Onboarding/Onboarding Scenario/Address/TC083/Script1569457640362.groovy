...
WebUI.setText(findTestObject('MERCHANT/User Settings/Address/textbox_first_name'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Address/textbox_first_name'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Address/textbox_first_name'), 'value', '', 0)
