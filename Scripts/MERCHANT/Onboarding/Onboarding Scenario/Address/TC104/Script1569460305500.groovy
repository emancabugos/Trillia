...
WebUI.setText(findTestObject('MERCHANT/User Settings/Address/textbox_postal_code'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Address/textbox_postal_code'), Keys.chord(Keys.BACK_SPACE))

WebUI.delay(1)

WebUI.click(findTestObject('MERCHANT/User Settings/Address/button_Add'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Address/textbox_postal_code'), 'value', '', 0)
