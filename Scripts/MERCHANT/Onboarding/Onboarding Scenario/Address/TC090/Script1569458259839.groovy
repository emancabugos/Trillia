...
WebUI.setText(findTestObject('MERCHANT/User Settings/Address/textbox_address'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Address/textbox_address'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Address/textbox_address'), 'value', '', 0)
