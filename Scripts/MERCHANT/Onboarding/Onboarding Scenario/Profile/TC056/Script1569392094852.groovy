...
WebUI.click(findTestObject('MERCHANT/User Settings/Profile/button_Change'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(2)

WebUI.verifyElementClickable(findTestObject('MERCHANT/Image Cropper/button_upload item'), FailureHandling.CONTINUE_ON_FAILURE)
