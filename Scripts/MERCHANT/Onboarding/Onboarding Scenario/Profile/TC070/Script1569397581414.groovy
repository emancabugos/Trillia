...
WebUI.setText(findTestObject('MERCHANT/User Settings/Profile/textbox_last_name'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Profile/textbox_last_name'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Profile/textbox_last_name'), 'value', '', 0)
