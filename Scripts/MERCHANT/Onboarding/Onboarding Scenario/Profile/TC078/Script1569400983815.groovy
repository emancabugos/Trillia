...
WebUI.setText(findTestObject('MERCHANT/User Settings/Profile/textbox_contact'), ' ')

WebUI.sendKeys(findTestObject('MERCHANT/User Settings/Profile/textbox_contact'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/User Settings/Profile/textbox_contact'), 'value', '', 0)
