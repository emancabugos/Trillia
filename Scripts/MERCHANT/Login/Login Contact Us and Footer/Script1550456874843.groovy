...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Login Seller/button_Contact us'), 0)

WebUI.click(findTestObject('MERCHANT/Login Seller/button_Contact us'), FailureHandling.CONTINUE_ON_FAILURE)
