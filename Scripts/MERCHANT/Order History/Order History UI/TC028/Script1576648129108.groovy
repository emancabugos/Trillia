...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/textlabel_Your order(s) selected deliv'), 
    0)

WebUI.verifyElementPresent(findTestObject('MERCHANT/Order Page/Pick-up status/textlabel_Your order(s) selected deliv'), 
    0)
