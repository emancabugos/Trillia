...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/textlabel_ORDER STATUS CHANGE'), 0)

WebUI.verifyElementPresent(findTestObject('MERCHANT/Order Page/Pick-up status/textlabel_ORDER STATUS CHANGE'), 0)
