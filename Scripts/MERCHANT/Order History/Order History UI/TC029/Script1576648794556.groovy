...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/button_Created'), 0)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/button_Created'), 0)

WebUI.verifyElementPresent(findTestObject('MERCHANT/Order Page/Pick-up status/button_Acknowledged'), 0)

WebUI.verifyElementPresent(findTestObject('MERCHANT/Order Page/Pick-up status/button_Acknowledged'), 0)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/button_Ready for Pick-up'), 0)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Order Page/Pick-up status/button_Ready for Pick-up'), 0)

WebUI.verifyElementPresent(findTestObject('MERCHANT/Order Page/Pick-up status/button_Collected'), 0)
