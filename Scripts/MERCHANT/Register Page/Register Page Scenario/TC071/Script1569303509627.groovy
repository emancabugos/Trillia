...
WebUI.setText(findTestObject('MERCHANT/Register Page/textbox_NotificationEmail'), 'INVALID')

WebUI.click(findTestObject('MERCHANT/Register Page/button_Sign Up'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Register Page/textbox_NotificationEmail'), 'value', 'INVALID', 
    0)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Register Page/Toaster Message/invalid email'), 0)

WebUI.waitForElementNotPresent(findTestObject('MERCHANT/Register Page/Toaster Message/invalid email'), 0, FailureHandling.CONTINUE_ON_FAILURE)
