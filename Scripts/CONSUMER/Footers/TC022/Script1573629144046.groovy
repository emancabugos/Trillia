...
WebUI.click(findTestObject('CONSUMER/Footer/linktext_ABOUT'))

WebUI.waitForElementVisible(findTestObject('CONSUMER/Footer/tab_About'), 0)

WebUI.verifyElementVisible(findTestObject('CONSUMER/Footer/tab_About'))

WebUI.click(findTestObject('CONSUMER/Footer/tab_TermsOfUse'))
