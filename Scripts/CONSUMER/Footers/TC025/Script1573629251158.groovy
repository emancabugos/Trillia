...
WebUI.scrollToElement(findTestObject('CONSUMER/Footer/linktext_RETURNS'), 0)

WebUI.verifyElementVisible(findTestObject('CONSUMER/Footer/linktext_RETURNS'))

WebUI.click(findTestObject('CONSUMER/Footer/linktext_RETURNS'))

WebUI.waitForElementVisible(findTestObject('CONSUMER/Footer/tab_Returns'), 0)

WebUI.verifyElementVisible(findTestObject('CONSUMER/Footer/tab_Returns'))

WebUI.click(findTestObject('CONSUMER/Footer/tab_About'))
