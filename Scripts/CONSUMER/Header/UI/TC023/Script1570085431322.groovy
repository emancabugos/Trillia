...
WebUI.verifyElementVisible(findTestObject('CONSUMER/Homepage/icon_ComparisonList'))

WebUI.click(findTestObject('CONSUMER/Homepage/icon_ComparisonList'))

WebUI.waitForElementVisible(findTestObject('CONSUMER/Evaluation List/table_DATE CREATED'), 0)
