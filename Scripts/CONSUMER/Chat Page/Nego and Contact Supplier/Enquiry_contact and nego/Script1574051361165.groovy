...
if (findTestData('CONSUMER/Evaluation List').getValue(1, 1) == 'nego') {
    WebUI.waitForElementVisible(findTestObject('CONSUMER/Homepage/textfield_Search'), 0)

    WebUI.setText(findTestObject('CONSUMER/Homepage/textfield_Search'), findTestData('CONSUMER/Evaluation List').getValue(
            1, 1))
    ...
    WebElement element2 = WebUiCommonHelper.findWebElement(findTestObject('CONSUMER/Homepage/button_Search'), 30)
    ...
    WebElement element = WebUiCommonHelper.findWebElement(findTestObject('CONSUMER/Item Details Page/Page_Item Detail/span_Contact Supplier'), 
        30)
