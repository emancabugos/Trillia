...
WebUI.clearText(findTestObject('CONSUMER/Settings/textfield_FirstNameAddress'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('CONSUMER/Settings/textfield_FirstNameAddress'), FailureHandling.CONTINUE_ON_FAILURE)
