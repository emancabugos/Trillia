...
WebUI.waitForElementVisible(findTestObject('CONSUMER/User Menu/linktext_ChangePassword'), 0)

WebUI.click(findTestObject('CONSUMER/User Menu/linktext_ChangePassword'))
