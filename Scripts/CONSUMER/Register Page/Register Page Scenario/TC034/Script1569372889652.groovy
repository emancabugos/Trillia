...
WebUI.setText(findTestObject('MERCHANT/Register Page/textbox_reconfirm-password'), 'mismatch')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Register Page/textbox_reconfirm-password'), 'value', 'mismatch', 
    0)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Register Page/Toaster Message/mismatch password'), 0)

WebUI.waitForElementNotPresent(findTestObject('MERCHANT/Register Page/Toaster Message/mismatch password'), 0, FailureHandling.CONTINUE_ON_FAILURE)
