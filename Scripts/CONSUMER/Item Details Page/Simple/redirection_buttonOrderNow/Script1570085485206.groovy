...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Evaluation Widget/button_OrderNow'), 0)

WebUI.verifyElementVisible(findTestObject('CONSUMER/Evaluation Widget/button_OrderNow'))

WebUI.click(findTestObject('CONSUMER/Evaluation Widget/button_OrderNow'))
