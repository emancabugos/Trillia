...
'Verify if toaster message is displayed upon inputting invalid username & password\r\n'
WebUI.openBrowser('')
...
WebUI.comment('Toaster message is displayed upon inputting invalid username & password')
...
WebUI.comment('No toaster message yet')
