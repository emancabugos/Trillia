...
'Verify if Back button is present and clickable'
WebUI.openBrowser('')
...
WebUI.verifyElementVisible(findTestObject('CONSUMER/Login Buyer/back_button'))

WebUI.verifyElementClickable(findTestObject('CONSUMER/Login Buyer/back_button'))
